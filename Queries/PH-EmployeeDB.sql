...
---We're looking for employees born between 1952 and 1955, 
...
---This time, the change we'll make to the code is also 
---small—we're modifying the SELECT statement into a 
---SELECT INTO statement. This statement tells Postgres 
---that instead of generating a list of results, the data 
---is saved as a new table completely.
SELECT first_name, last_name
INTO retirement_info ---<<<change was mad here
FROM employees
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (hire_date BETWEEN '1985-01-01' AND '1988-12-31');
